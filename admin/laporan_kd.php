                ...
                <div class="col-md-12 col-sm-6 col-xs-6">
                    <center>
                        <div class="panel panel-back noti-box">
                            <div class="text-box">
                                <p class="main-text">
                                    <font face="Garamond">Laporan Pelayanan SKD <br>(Surat Keterangan Domisili)</font>
                                </p>
                            </div><br>
                        </div>
                    </center>
                    <form method="post" action="download_laporan_kd.php">
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="card col-md-12 p-0">
                                ...
                                <div class="card-body">
                                    <div class="card-body table-responsive p-0" style="height: 425px;">
                                      ...
                                      kd.id_user = user.id_user ORDER BY tanggal_kd DESC");
                                            ?>
                                            <?php $nomor = 1;
                                            ?>
                                            <tbody>
                                    ...
                                    <a href="laporan_kd.php" class="btn btn-success" onclick="window.open('download_laporan_kd2.php')">Download Semua Data</a>
