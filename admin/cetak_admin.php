                                ...
                                <div class="card-body">
                                    <table class="table table-bordered">
                                        ...
                                        if (isset($_POST['dari']) && isset($_POST['ke'])) {
                                            ...
                                            ON pelayanan.id_user=user.id_user JOIN adm ON adm.id_admin = pelayanan.id_admin WHERE tanggal_layanan BETWEEN '$tgl_mulai' and '$tgl_selesai' ORDER BY tanggal_layanan ASC");
                                        } else {
                                            $data = mysqli_query($koneksi, "SELECT * FROM pelayanan JOIN nama_pelayanan ON
                                            pelayanan.id_nama_pelayanan=nama_pelayanan.id_nama_pelayanan JOIN user
