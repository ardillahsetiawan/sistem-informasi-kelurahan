                    ...
                    <div class="container-contact2">
                        <div class="wrap-contact2">
                            ...
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                <input type="hidden" name="id_p" class="form-control" value="kp-<?php echo $hasil_2; ?>">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group" data-validate="Message is required">
                                            <label for=""><b>*Photo hitam putih ukuran 3 x 4</b></label><br>
                            ...
                            if (isset($_POST['simpan'])) {
                                ...
                                pengantar_rt_rw, pas_foto_1, pas_foto_2, status_kp)
                                VALUES (
                                '$_POST[id_p]',
