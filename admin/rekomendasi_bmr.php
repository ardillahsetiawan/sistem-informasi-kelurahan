...
$ambil = $koneksi->query("SELECT * FROM bmr JOIN user ON bmr.id_user=user.id_user
      WHERE id_bmr='$_GET[id_bmr]'");
$detail = $ambil->fetch_assoc();
?>

<head>
	<title>Surat Keterangan Tidak / Belum Memiliki Rumah</title>
	<style type="text/css">
		table {
			border-style: double;
			border-width: 3px;
...
<body>
	...
	<body onload="window.print()">
		...
		<table>
			<center>
				<tr>
					<td class="text"><u>SURAT KETERANGAN TIDAK / BELUM MEMILIKI RUMAH</u></td>
				</tr>
				<tr>
					<td class="text3">No. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<!--isi-->/&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<table width="500" style="text-align:justify; text-indent: 0.2in;" cellspacing=1 cellpadding=1>
			<tr>
				<td>Berdasarkan Pengantar <b>RT.
						...
						<?php echo $detail['rw'] ?>
					</b> dan pernyataan yang bersangkutan, bahwa nama
					tersebut selama bertempat tinggal di lingkungan <b>RT.
						<?php echo $detail['rt'] ?> RW.
						<?php echo $detail['rw'] ?>
					</b> dan sampai saat surat keterangan
					ini dibuat benar-benar tidak memiliki rumah/tempat tinggal.</td>
			</tr>
		</table>
