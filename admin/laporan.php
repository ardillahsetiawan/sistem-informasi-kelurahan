                ...
                <div class="col-md-12 col-sm-6 col-xs-6">
                    <center>
                        <div class="panel panel-back noti-box">
                            <div class="text-box">
                                <p class="main-text">
                                    <font face="Garamond">Laporan Pelayanan</font>
                                </p>
                            </div><br>
                        </div>
                    </center>
                            ...
                            <div class="card col-md-12 p-0">
                                ...
                                <div class="card-body">
                                    <div class="card-body table-responsive p-0" style="height: 373px;">
                                        ...
                                        ON pelayanan.id_user=user.id_user ORDER BY tanggal_layanan DESC");
                                            ?>
                                            <?php $nomor = 1;
                                            ?>
                                ...
                                <br>
                                <a href="laporan.php" class="btn btn-success" onclick="window.open('cetak2.php')">Download Semua Data</a>
                                <!-- /.card-body -->
                            </div>
                        </div>
                    </div>
