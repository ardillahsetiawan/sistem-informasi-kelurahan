                    ...
                    <div class="row">
                        <div class="card col-md-12 p-0">
                            ...
                            <div class="card-header">
                                ...
                                <h5 class="text-center"><b>Laporan SKP <br>(Surat Keterangan Pindah)</b></h5><br>
                                ...
                                <div class="card-body">
                                    <table class="table table-bordered">
                                        ...
                                        if (isset($_POST['dari']) && isset($_POST['ke'])) {
                                            $data = mysqli_query($koneksi, "SELECT * FROM kp JOIN user ON
                                            kp.id_user = user.id_user WHERE tanggal_kp BETWEEN '$tgl_mulai' and '$tgl_selesai' ORDER BY tanggal_kp ASC");
                                        } else {
                                            $data = mysqli_query($koneksi, "SELECT * FROM user INNER JOIN kp ON user.id_user = kp.id_user");
                                        }
                                        ?>
                                        <?php $nomor = 1;
                                        ?>
                                        ...
                                        <tbody>
                                            <?php while ($d = mysqli_fetch_array($data)) { ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $d['keperluan_surat_kp'] ?></td>
                                                    <td><?php echo date('d F Y', strtotime($d['tanggal_kp'])); ?></td>
                                                    <td>
                                                        <?php if ($d['status_kp'] == NULL) : ?> <span>Berkas Belum Lengkap</span>
                                                        <?php else : ?>
                                                            <?php echo $d['status_kp']; ?>
                                                        <?php endif ?>
                                                    </td>
                                                </tr>
                                                <?php $nomor++; ?>
