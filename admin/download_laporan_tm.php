                    ...
                    <div class="row">
                        <div class="card col-md-12 p-0">
                            ...
                            <div class="card-header">
                                ...
                                <h5 class="text-center"><b>Laporan SKTM <br>(Surat Keterangan Tidak Mampu)</b></h5><br>
                                ...
                                <div class="card-body">
                                    <table class="table table-bordered">
                                        ...
                                        if (isset($_POST['dari']) && isset($_POST['ke'])) {
                                            ...
                                            tm.id_user = user.id_user WHERE tanggal_tm BETWEEN '$tgl_mulai' and '$tgl_selesai' ORDER BY tanggal_tm ASC");
                                        } else {
                                            $data = mysqli_query($koneksi, "SELECT * FROM user INNER JOIN tm ON user.id_user = tm.id_user");
                                        }
                                        ?>
                                        <?php $nomor = 1;
                                        ?>
                                        ...
                                        <tbody>
                                            <?php while ($d = mysqli_fetch_array($data)) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if ($d['status_tm'] == NULL) : ?> <span>Berkas Belum Lengkap</span>
                                                        <?php else : ?>
