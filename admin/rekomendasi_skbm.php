...
$ambil = $koneksi->query("SELECT * FROM bm JOIN user ON bm.id_user=user.id_user
      WHERE id_bm='$_GET[id_bm]'");
$detail = $ambil->fetch_assoc();
?>

<head>
	<title>Surat Keterangan BELUM MENKAH</title>
	<style type="text/css">
		table {
			border-style: double;
			border-width: 3px;
...
<body>
	...
	<body onload="window.print()">
		...
		<table>
			<center>
				<tr>
					<td class="text"><u>SURAT KETERANGAN BELUM MENKAH</u></td>
				</tr>
				<tr>
					<td class="text3">No. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<!--isi-->/&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<table width="500" style="text-align:justify; text-indent: 0.2in;" cellspacing=1 cellpadding=1>
			<tr>
				<td>Dengan ini menerangkan bahwa orang tersebut diatas memang benar-benar penduduk Kelurahan Selat Hulu Kuala Kapuas dan benar bahwa belum pernah menikah. <br>
					Surat keterangan ini dipergunakan untuk syarat melamar pekerjaan di perusahaan. <br>
					Demikian Surat ini kami buat dan keluarkan dengan sebenarnya dan agar dapat dipergunakan sebagaimana mestinya.
				</td>
			</tr>
		</table>
