...
$ambil = $koneksi->query("SELECT * FROM kd JOIN user ON kd.id_user=user.id_user
...
<body>
	...
	<body onload="window.print()">
		...
		<table>
			<center>
				<tr>
					<td class="text"><u>SURAT KETERANGAN DOMISILI</u></td>
				</tr>
				<tr>
					<td class="text3">No. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<!--isi-->/&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<table width="500" style="text-align:justify; text-indent: 0.2in;" cellspacing=1 cellpadding=1>
			<tr>
				<td>
					Orang tersebut diatas, adalah benar-benar warga kami dan berdomisili di <b>RT.
						<?php echo $detail['rt'] ?> RW.
						<?php echo $detail['rw'] ?> Kelurahan Selat Hulu Kuala Kapuas.</td>
			</tr>
		</table>
