                ...
                <div class="col-md-12 col-sm-6 col-xs-6">
                    <center>
                        <div class="panel panel-back noti-box">
                            <div class="text-box">
                                <p class="main-text">
                                    <font face="Garamond">Laporan Petugas Verifikasi</font>
                                </p>
                            </div><br>
                        </div>
                    </center>
                    <form method="post" action="cetak_admin.php">
                        <div class="row">
                            <div class="col-md-4">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="card col-md-12 p-0">
                                ...
                                <div class="card-body">
                                    <div class="card-body table-responsive p-0" style="height: 373px;">
                                        ...
                                        ON pelayanan.id_user=user.id_user JOIN adm ON adm.id_admin = pelayanan.id_admin ORDER BY tanggal_layanan DESC");
                                            ?>
                                            <?php $nomor = 1;
                                            ?>
                                            ...
                                            <tbody>
                                                <?php while ($d = mysqli_fetch_array($data)) { ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo date('d F Y', strtotime($d['tanggal_layanan'])); ?></td>
                                ...
                                <br>
                                <a href="laporan_admin.php" class="btn btn-success" onclick="window.open('cetak_admin2.php')">Download Semua Data</a>
                                <!-- /.card-body -->
                            </div>
                        </div>
                    </div>
