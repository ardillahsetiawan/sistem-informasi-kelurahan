...
<hbml lang="en">
    ...
    <?php
    $ambil = $koneksi->query("SELECT * FROM bm JOIN user ON bm.id_user=user.id_user WHERE id_bm='$_GET[id_bm]'");
                        ...
                        <div class="row">
                            <div class="card col-md-12">
                                ...
                                <div class="card-header">
                                    <u>
                                        <h3 class="text-center"><b>Surat Keterangan Belum Menikah</b></h3><br>
                                    </u>
                                    <div class="row">
                                        <div class="col-md-1">
                                            <h5>Nama</h5>
                                        ...
                                        <div class="col-md-7">
                                            ...
                                            <h5>: &ensp;<?php echo $detail['keperluan_surat_bm']; ?></h5>
                                        </div>
                                        <div class="col-md-3">
                                            <b>
                                        ...
                                        <div class="col-md-3">
                                            <form action="" method=" POST" id="verifikasi">
                                                <?php
                                                $id_bm = $_GET['id_bm'];
                                                $koneksi->query("SELECT * FROM bm WHERE id_bm= '$id_bm'"); ?>
                                                <div class="form-group">
                                                    <?php if ($detail['status_bm'] == NULL) : ?>
                                                        <label type="text" class="form-control" disabled>Belum Verifikasi
                                                        <?php else : ?>
                                                            <input type="text" class="form-control" value="<?php echo $detail['status_bm']; ?>" disabled>
                                                        <?php endif ?>
                                                </div>
                                            </form>
                                            ...
                                            <form action="" method="Post">
                                                <div class="form-group">
                                                    ...
                                                    <select name="status_bm" id="" class="form-control">
                                                        ...
                                                        <?php if ($detail['status_pekawinan'] != 'Belum Kawin') { ?>
                                                            <option value="Ditolak (Hanya Untuk yang Belum Menikah)">Hanya Untuk yang Belum Menikah</option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                                <button class="btn btn-info" name="ubah">Simpan</button>
                                                <a href="bm.php" class="btn btn-warning">Kembali</a>
                                            </form>
                                        </div>
                                    </div><br><br>
                                    <?php
                            ...
                            <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <?php if ($detail['pengantar_rt_rw'] == !NULL) : ?>
                                                    <a href="../berkas_bm/<?php echo $detail['pengantar_rt_rw'] ?>" target="_blank" class="btn btn-info"><span class="fa fa-print"></span> Lihat</a>
                                                <?php endif ?>
                                            </td>
                                            <td class="text-center">
                                                <?php echo $detail['status_bm']; ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>2</td>
                                            ...
                                            <td class="text-center">
                                                <?php if ($detail['ktp_saksi_1'] == !NULL) : ?>
                                                    <a href="../berkas_bm/<?php echo $detail['ktp_saksi_1'] ?>" target="_blank" class="btn btn-info"><span class="fa fa-print"></span> Lihat</a>
                                                <?php endif ?>
                                            </td>
                                            <td class="text-center">
                                                <?php echo $detail['status_bm']; ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <?php if ($detail['ktp_saksi_2'] == !NULL) : ?>
                                                    <a href="../berkas_bm/<?php echo $detail['ktp_saksi_2'] ?>" target="_blank" class="btn btn-info"><span class="fa fa-print"></span> Lihat</a>
                                                <?php endif ?>
                                            </td>
                                            <td class="text-center">
                                                <?php echo $detail['status_bm']; ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <?php if ($detail['surat_pernyataan_rt_rw'] == !NULL) : ?>
                                                    <a href="../berkas_bm/<?php echo $detail['surat_pernyataan_rt_rw'] ?>" target="_blank" class="btn btn-info"><span class="fa fa-print"></span> Lihat</a>
                                                <?php endif ?>
                                            </td>
                                            <td class="text-center">
                                                <?php echo $detail['status_bm']; ?>
                                ...
                                <div class="row">
                                    <div class="col-lg-4 ">
                                        <a href="bm.php" class="btn btn-secondary">KEMBALI</a>
                                        <?php if ($detail['status_bm'] == "Verifikasi") : ?>
                                            <a href="rekomendasi_skbm.php?id_bm=<?php echo $detail['id_bm'] ?>" class="btn btn-success" name="cetak rekomendasi_bm" target="_blank">CETAK REKOMENDASI</a>
                                        <?php endif ?>
                                    </div>
                                </div>
                            </div>
