                ...
                <div class="col-md-12 col-sm-6 col-xs-6">
                    <center>
                        <div class="panel panel-back noti-box">
                            <div class="text-box">
                                <p class="main-text">
                                    <font face="Garamond">Laporan Pelayanan SKU <br>(Surat Keterangan Usaha)</font>
                                </p>
                            </div><br>
                        </div>
                    </center>
                    <form method="post" action="download_laporan_sku.php">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="card-body">
                                    <div class="card-body table-responsive p-0" style="height: 425px;">
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <?php
                                            $data = mysqli_query($koneksi, "SELECT * FROM sku JOIN user ON
                                      sku.id_user = user.id_user ORDER BY tanggal_sku DESC");
                                            ?>
                                            <?php $nomor = 1;
                                            ?>
                                            <tbody>
                                    ...
                                    <a href="laporan_sku.php" class="btn btn-success" onclick="window.open('download_laporan_sku2.php')">Download Semua Data</a>
