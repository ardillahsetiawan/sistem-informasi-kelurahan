                    ...
                    <div class="row">
                        <div class="card col-md-12 p-0">
                            ...
                            <div class="card-header">
                                ...
                                <h5 class="text-center"><b>Laporan SKAW <br>(Surat Keterangan Ahli Waris)</b></h5><br>
                                ...
                                <div class="card-body">
                                    <table class="table table-bordered">
                                        ...
                                        if (isset($_POST['dari']) && isset($_POST['ke'])) {
                                            $data = mysqli_query($koneksi, "SELECT * FROM kaw JOIN user ON
                                            kaw.id_user = user.id_user WHERE tanggal_kaw BETWEEN '$tgl_mulai' and '$tgl_selesai' ORDER BY tanggal_kaw ASC");
                                        } else {
                                            $data = mysqli_query($koneksi, "SELECT * FROM user INNER JOIN kaw ON user.id_user = kaw.id_user");
                                        }
                                        ?>
                                        <?php $nomor = 1;
                                        ?>
                                        ...
                                        <tbody>
                                            <?php while ($d = mysqli_fetch_array($data)) { ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $d['keperluan_surat_kaw'] ?></td>
                                                    <td><?php echo date('d F Y', strtotime($d['tanggal_kaw'])); ?></td>
                                                    <td>
                                                        <?php if ($d['status_kaw'] == NULL) : ?> <span>Berkas Belum Lengkap</span>
                                                        <?php else : ?>
                                                            <?php echo $d['status_kaw']; ?>
                                                        <?php endif ?>
                                                    </td>
                                                </tr>
                                                <?php $nomor++; ?>
