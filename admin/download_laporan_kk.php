                    ...
                    <div class="row">
                        <div class="card col-md-12 p-0">
                            ...
                            <div class="card-header">
                                ...
                                <h5 class="text-center"><b>Laporan SKK <br>(Surat Keterangan Kematian)</b></h5><br>
                                ...
                                <div class="card-body">
                                    <table class="table table-bordered">
                                        ...
                                        if (isset($_POST['dari']) && isset($_POST['ke'])) {
                                            $data = mysqli_query($koneksi, "SELECT * FROM kk JOIN user ON
                                            kk.id_user = user.id_user WHERE tanggal_kk BETWEEN '$tgl_mulai' and '$tgl_selesai' ORDER BY tanggal_kk ASC");
                                        } else {
                                            $data = mysqli_query($koneksi, "SELECT * FROM user INNER JOIN kk ON user.id_user = kk.id_user");
                                        }
                                        ?>
                                        <?php $nomor = 1;
                                        ?>
                                        ...
                                        <tbody>
                                            <?php while ($d = mysqli_fetch_array($data)) { ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $d['keperluan_surat_kk'] ?></td>
                                                    <td><?php echo date('d F Y', strtotime($d['tanggal_kk'])); ?></td>
                                                    <td>
                                                        <?php if ($d['status_kk'] == NULL) : ?> <span>Berkas Belum Lengkap</span>
                                                        <?php else : ?>
                                                            <?php echo $d['status_kk']; ?>
                                                        <?php endif ?>
                                                    </td>
                                                </tr>
                                                <?php $nomor++; ?>
