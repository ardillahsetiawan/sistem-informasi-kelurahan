...
$ambil = $koneksi->query("SELECT * FROM km JOIN user ON km.id_user=user.id_user
      WHERE id_km='$_GET[id_km]'");
$detail = $ambil->fetch_assoc();
?>

<head>
	<title>Surat Keterangan MENKAH</title>
	<style type="text/css">
		table {
			border-style: double;
			border-width: 3px;
...
<body>
	...
	<body onload="window.print()">
		...
		<table>
			<center>
				<tr>
					<td class="text"><u>SURAT KETERANGAN MENKAH</u></td>
				</tr>
				<tr>
					<td class="text3">No. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<!--isi-->/&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<table width="500" style="text-align:justify; text-indent: 0.2in;" cellspacing=1 cellpadding=1>
			<tr>
				<td>Adalah benar telah menikah secara agama islam di Desa/Lurah
					Selat Hulu Selatan Kuala Kapuas Yang dilakukan oleh Pemuka Agama/Penghulu Desa/Lurah Selat Hulu. <br>
					Demikian surat keterangan Nikah ini dibuat dan hanya berlaku untuk memohon Penerbitan Akta Kelahiran pada Dinas Kependudukan dan Pencatatan Sipil Kabupaten Kuala Kapuas.
				</td>
			</tr>
		</table>
