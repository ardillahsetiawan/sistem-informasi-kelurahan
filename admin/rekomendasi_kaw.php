...
$ambil = $koneksi->query("SELECT * FROM kaw JOIN user ON kaw.id_user=user.id_user
...
<body>
	...
	<body onload="window.print()">
		...
		<table>
			<center>
				<tr>
					<td class="text"><u>SURAT KETERANGAN AHLI WARIS</u></td>
				</tr>
				<tr>
					<td class="text3">No. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<!--isi-->/&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<br>
		<center>
			<h5>Yang tersebut di atas adalah benar ahli waris dari almarhum :</h5>
		</center>
		<table cellspacing="0" width=550 border="0" cellpadding=3>
			<tr>
				<td width="100">Nama</td>
				<td>:
					<?php echo $detail['yg_meninggal']; ?>
				</td>
			</tr>
			<tr>
				<td width="100">Umur</td>
				<td>:
					<?php echo $detail['umur']; ?>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>:
					<?php echo $detail['tanggal_meninggal']; ?>
				</td>
			</tr>
		</table>
		...
		<table width="500" style="text-align:justify; text-indent: 0.2in;" cellspacing=1 cellpadding=1>
			<tr>
				<td>
					Bahwa para ahli waris tersebut diatas adalah benar-benar Ahli Waris dari Almarhum <?php echo $detail['yg_meninggal']; ?> dan tidak ada lagi ahli waris yang lain selain tersebut diatas dan kami bertanggung jawab atas kebenaran dari pernyataan ini
				</td>
			</tr>
			<tr>
				<td>Demikian surat keterangan kematian ini diberikan sebagai bahan seperlunya.</td>
			</tr>
		</table>
		<br><br>
