                    ...
                    <div class="row">
                        <div class="card col-md-12 p-0">
                            ...
                            <div class="card-header">
                                ...
                                <h5 class="text-center"><b>Laporan SKBM <br>(Surat Keterangan Belum Menikah)</b></h5><br>
                                ...
                                <div class="card-body">
                                    <table class="table table-bordered">
                                        ...
                                        if (isset($_POST['dari']) && isset($_POST['ke'])) {
                                            $data = mysqli_query($koneksi, "SELECT * FROM bm JOIN user ON
                                            bm.id_user = user.id_user WHERE tanggal_bm BETWEEN '$tgl_mulai' and '$tgl_selesai' ORDER BY tanggal_bm ASC");
                                        } else {
                                            $data = mysqli_query($koneksi, "SELECT * FROM user INNER JOIN bm ON user.id_user = bm.id_user");
                                        }
                                        ?>
                                        <?php $nomor = 1;
                                        ?>
                                        ...
                                        <tbody>
                                            <?php while ($d = mysqli_fetch_array($data)) { ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $d['keperluan_surat_bm'] ?></td>
                                                    <td><?php echo $d['pekerjaan'] ?></td>
                                                    <td><?php echo $d['kewarganegaraan'] ?></td>
                                                    <td><?php echo date('d F Y', strtotime($d['tanggal_bm'])); ?></td>
                                                    <td>
                                                        <?php if ($d['status_bm'] == NULL) : ?> <span>Berkas Belum Lengkap</span>
                                                        <?php else : ?>
                                                            <?php echo $d['status_bm']; ?>
                                                        <?php endif ?>
                                                    </td>
                                                </tr>
                                                <?php $nomor++; ?>
