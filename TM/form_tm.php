...
<body>
		...
		<div class="container-contact2">
			<div class="wrap-contact2">
				<form class="" method="POST">
					...
					<input type="hidden" name="id_p" class="form-control" value="tm-<?php echo $hasil_1; ?>">
					...
					<div class="form-group" data-validate="Message is required">
						...
						<input type="Date" name="tanggal_tm" value="" class="form-control" required oninvalid="this.setCustomValidity('Tanggal Harus Anda Input!')" oninput="setCustomValidity('')">
					</div><br>
	...
	if (isset($_POST['ubah'])) {
		...
		$koneksi->query("INSERT INTO pelayanan (id_pelayanan, id_nama_pelayanan, id_user, tanggal_layanan)
		 VALUES ('$_POST[id_p]', '$_POST[nama_p]', '$_POST[id]', '$_POST[tanggal_tm]')");

		$koneksi->query("INSERT INTO tm (id_pelayanan, keperluan_surat_tm, tanggal_tm, id_user,
		pekerjaan)
		VALUES (
		'$_POST[id_p]',
